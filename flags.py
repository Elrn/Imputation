...
""" Dataset Setting """
########################################################################################################################
flags.DEFINE_integer('row_lengths', 64, '', lower_bound=0)
flags.DEFINE_integer('input_dim', 36, '', lower_bound=0)
...
flags.DEFINE_string('data_dir', 'C:\\dataset\\PhysioNet', '')
flags.DEFINE_string('arr_dir', 'C:\\dataset\\PhysioNet\\2012\\arr', '')
flags.DEFINE_string('txt_dir', 'C:\\dataset\\PhysioNet\\2012\\set', '')
