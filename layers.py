...
########################################################################################################################
class GRUICell(GRUCell):
    """
    [!] recurrent.py 에 추가할 것
    """
    def __init__(self,
                 units,
                 activation='tanh',
    ...
    def build(self, input_shape):
        ...
        self.w = tf.keras.layers.Embedding(1, [input_dim, 1], embeddings_initializer='ones')
        self.b = tf.keras.layers.Embedding(1, [input_dim, 1], embeddings_initializer='zeros')
